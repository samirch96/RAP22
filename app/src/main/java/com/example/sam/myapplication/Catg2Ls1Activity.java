...
public class Catg2Ls1Activity extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg2_ls1);
      ...
      /*  bes.setOnClickListener(new View.OnClickListener() {
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg2Ls1Activity.this);
...
//                        int h = x.getInt("pt_a",0);
                        switch (lang){
                            case 1:
                                    ...
                                    xx.putInt("pt_a", h-20);
                                    xx.apply();*/
                                Intent i1 = new Intent(Catg2Ls1Activity.this, TTSFRActivity.class);
                                startActivity(i1);
                            ...
                            case 2:
                                   ...
                                   /* x = getSharedPreferences("xx", 0);
                                    ...
                                    xx.putInt("pt_a",  h-20);
                                    xx.apply();*/
                                Intent i2 = new Intent(Catg2Ls1Activity.this, TTSActivity.class);
                                startActivity(i2);
    ...
    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg2Ls1Activity> activityReference;
        SetupTask(Catg2Ls1Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 5){
                    finish();
                    Intent i = new Intent(Catg2Ls1Activity.this, Card2Activity.class);
                    startActivity(i);
        ...
        if(lang==1){
            ...
            switchSearch(MUSICAL);
            String tab[]={"tambour", "orateur","gong","guitare","harpe"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
