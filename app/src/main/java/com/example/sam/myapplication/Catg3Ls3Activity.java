...
public class Catg3Ls3Activity extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg3_ls3);
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg3Ls3Activity.this);
                a_builder.setMessage("Secrifi 20 points ?").setCancelable(false).setPositiveButton("yes" , new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (lang){
                            case 1:
                                    Intent i1 = new Intent(Catg3Ls3Activity.this, TTSFRActivity.class);
                                    startActivity(i1);
                                    break;
                            case 2:
                                    Intent i2 = new Intent(Catg3Ls3Activity.this, TTSActivity.class);
                                    startActivity(i2);
                                    break;
                            default:break;
                        }
        ...
        new Catg3Ls3Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg3Ls3Activity> activityReference;
        SetupTask(Catg3Ls3Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            String tab[]={"satellite", "keyboard","modem","usb"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 4){
                    finish();
                    Intent i = new Intent(Catg3Ls3Activity.this, Card3Activity.class);
                    startActivity(i);
        ...
        if(lang==1){
            ...
            switchSearch(INFOFR);
            String tab[]={" satellite", " clavier","modem","port"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
        ...
        if(lang==3) {
            switchSearch(INFOIT);
            //  switchSearch(MUSICAL);
            String tab[] = {"usate", "uste","modem", "porto"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore() * -0.005);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File musicgrammer = new File(assetsDir, "sync/info.gram");
        ...
        File musicfrgrammer=new File (assetsDir, "sync/infofr.gram");
