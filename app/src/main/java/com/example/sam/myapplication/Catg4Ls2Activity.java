...
public class Catg4Ls2Activity extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg4_ls2);
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg4Ls2Activity.this);
                a_builder.setMessage("Secrifi 20 points ?").setCancelable(false).setPositiveButton("yes" , new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (lang){
                            case 1:
                                    Intent i1 = new Intent(Catg4Ls2Activity.this, TTSFRActivity.class);
                                    startActivity(i1);
                                break;
                            case 2:
                                    Intent i2 = new Intent(Catg4Ls2Activity.this, TTSActivity.class);
                                    startActivity(i2);
                                    break;
                            default:break;
                        }
        ...
        new Catg4Ls2Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg4Ls2Activity> activityReference;
        SetupTask(Catg4Ls2Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            String tab[]={"gloves", "grater","knife","microwave"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 4){
                    finish();
                    Intent i = new Intent(Catg4Ls2Activity.this, Card4Activity.class);
                    startActivity(i);
        ...
        if(lang==1){
            ...
            switchSearch(CUISINFR);
            String tab[]={" gans","rapper","couteau","couteau"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
        ...
        if(lang==3) {
            ...
            //  switchSearch(MUSICAL);
            String tab[] = {"guance", "grato","afflitto", "caldo"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore() * -0.005);
