...
public class Catg5Ls1Activity extends Activity implements RecognitionListener {
    TextView result;
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg5_ls1);
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg5Ls1Activity.this);
...
//                        int h = x.getInt("pt_a",0);
                        switch (lang){
                            case 1:
                                    ...
                                    xx.putInt("pt_a", h-20);
                                    xx.apply();*/
                                Intent i1 = new Intent(Catg5Ls1Activity.this, TTSFRActivity.class);
                                startActivity(i1);
                            ...
                            case 2:
                                   ...
                                   /* x = getSharedPreferences("xx", 0);
                                    ...
                                    xx.putInt("pt_a",  h-20);
                                    xx.apply();*/
                                Intent i2 = new Intent(Catg5Ls1Activity.this, TTSActivity.class);
                                startActivity(i2);
        ...
        new Catg5Ls1Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg5Ls1Activity> activityReference;
        SetupTask(Catg5Ls1Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            String tab[]={"blender", "cleaner","dishwasher","fridge"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 4){
                    finish();
                    Intent i = new Intent(Catg5Ls1Activity.this, Card5Activity.class);
                    startActivity(i);
        ...
        if(lang==1){
            ...
            switchSearch(ELCTROFR);
            String tab[]={"mixage","nettoyée","lave-vaisselle","frigidaire"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
