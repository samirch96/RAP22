...
public class Card6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(""+sharedPreferences1.getInt("pt_s", 0));
        nn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card6Activity.this, Catg6LsActivity.class);
                startActivity(i);
            }
        });
        ...
        ff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card6Activity.this, ShaireScoreActivity.class);
                startActivity(i);
            }
        });
    }
