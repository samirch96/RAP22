...
public class Catg7Ls2Activity extends Activity implements RecognitionListener {
    ...
    SharedPreferences sc_b,x;

    SharedPreferences.Editor sc_bb,xx;
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg7_ls2);
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg7Ls2Activity.this);
                a_builder.setMessage("Secrifi 20 points ?").setCancelable(false).setPositiveButton("yes" , new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (lang){
                            case 1:
                                    Intent i1 = new Intent(Catg7Ls2Activity.this, TTSFRActivity.class);
                                    startActivity(i1);
                                break;
                            case 2:
                                    Intent i2 = new Intent(Catg7Ls2Activity.this, TTSActivity.class);
                                    startActivity(i2);
                                break;
                            default:break;
                        }
    ...
    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg7Ls2Activity> activityReference;
        SetupTask(Catg7Ls2Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if( hypothesis.getHypstr().equals(tab[co])){
            ...
            if (co == 2){
                finish();
                Intent i = new Intent(Catg7Ls2Activity.this, Card7Activity.class);
                startActivity(i);
                Toast.makeText(this, "K.O" , Toast.LENGTH_LONG).show();
               /* sc_b = getSharedPreferences("sc_b",0);
                sc_bb = sc_b.edit();
                sc_bb.putInt("sc_b",sc);
                sc_bb.apply();*/
                int a = x.getInt("pt_b",0);
