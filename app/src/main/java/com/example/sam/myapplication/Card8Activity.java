...
public class Card8Activity extends AppCompatActivity {
    Dialog myDialog;
    Button nn,aagd,ff;
    TextView tv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(""+sharedPreferences1.getInt("pt_f", 0));
        nn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card8Activity.this, Catg8LsActivity.class);
                startActivity(i);
            }
        });
        aagd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card8Activity.this, Catg5LsActivity.class);
                startActivity(i);
            }
        });
        ...
        ff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card8Activity.this, ShaireScoreActivity.class);
                startActivity(i);
            }
        });
    }
