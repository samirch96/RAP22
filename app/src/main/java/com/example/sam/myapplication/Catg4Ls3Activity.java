...
public class Catg4Ls3Activity extends Activity implements RecognitionListener {
    ...
    public static final String CUISINFR ="cuisinfr";
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg4_ls3);
        ...
        bfr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                reco1.startListening(CUISINFR);
                switchSearch(CUISINFR);
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg4Ls3Activity.this);
                a_builder.setMessage("Secrifi 20 points ?").setCancelable(false).setPositiveButton("yes" , new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (lang){
                            case 1:
                                    Intent i1 = new Intent(Catg4Ls3Activity.this, TTSFRActivity.class);
                                    startActivity(i1);
                                    break;
                            case 2:
                                    Intent i2 = new Intent(Catg4Ls3Activity.this, TTSActivity.class);
                                    startActivity(i2);
                                    break;
                            default:break;
                        }
        ...
        new Catg4Ls3Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg4Ls3Activity> activityReference;
        SetupTask(Catg4Ls3Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            String tab[]={"mixer", "peeler","skewr","strainer"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 4){
                    finish();
                    Intent i = new Intent(Catg4Ls3Activity.this, Card4Activity.class);
                    startActivity(i);
        ...
        if(lang==1){
            ...
            switchSearch(CUISINFR);
            String tab[]={" chaufage","épluché","brochette","passoire"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
        ...
        if(lang==3) {
            ...
            //  switchSearch(MUSICAL);
            String tab[] = {"miscela", "peeler","griglia", "filo"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore() * -0.005);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
      ...
      /*  File musicfrgrammer=new File (assetsDir, "sync/cuisinefr.gram");
        reco1.addGrammarSearch(CUISINFR,musicfrgrammer);
