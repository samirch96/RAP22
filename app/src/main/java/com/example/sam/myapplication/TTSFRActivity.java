...
public class TTSFRActivity extends CatgCardViewActivity  implements TextToSpeech.OnInitListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ttsfract);
