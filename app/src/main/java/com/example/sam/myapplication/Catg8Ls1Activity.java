...
public class Catg8Ls1Activity extends Activity implements RecognitionListener {
    TextView result;
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg8_ls1);
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg8Ls1Activity.this);
...
//                        int h = x.getInt("pt_a",0);
                        switch (lang){
                            case 1:
                                    ...
                                    xx.putInt("pt_a", h-20);
                                    xx.apply();*/
                                Intent i1 = new Intent(Catg8Ls1Activity.this, TTSFRActivity.class);
                                startActivity(i1);
                            ...
                            case 2:
                                   ...
                                   /* x = getSharedPreferences("xx", 0);
                                    ...
                                    xx.putInt("pt_a",  h-20);
                                    xx.apply();*/
                                Intent i2 = new Intent(Catg8Ls1Activity.this, TTSActivity.class);
                                startActivity(i2);
        ...
        new Catg8Ls1Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg8Ls1Activity> activityReference;
        SetupTask(Catg8Ls1Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            String tab[]={"algeria", "america","china","france","mali"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 5){
                    finish();
                    Intent i = new Intent(Catg8Ls1Activity.this, Card8Activity.class);
                    startActivity(i);
        ...
        if(lang==1){
            ...
            switchSearch(FLAGSFR);
            String tab[]={"algérie","amérique","chine","france","mali"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
