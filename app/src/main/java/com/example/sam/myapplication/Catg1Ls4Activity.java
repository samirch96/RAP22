...
public class Catg1Ls4Activity extends Catg1LsActivity implements RecognitionListener {
    TextView result;
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg1_ls4);
       ...
       /* bes.setOnClickListener(new View.OnClickListener() {
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg1Ls4Activity.this);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (lang){
                            case 1:
                                    ...
                                    Intent i1 = new Intent(Catg1Ls4Activity.this, TTSFRActivity.class);
                                    startActivity(i1);
                            ...
                            case 2:
                                    ...
                                    Intent i2 = new Intent(Catg1Ls4Activity.this, TTSActivity.class);
                                    startActivity(i2);
                            default:break;
                        }
                    }
        ...
        new Catg1Ls4Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg1Ls4Activity> activityReference;
        SetupTask(Catg1Ls4Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2) {
            switchSearch(ANIMALS);
            String tab[] = {"cockroach", "hyena", "crocodile", "dinosaur", "rhinoceros","hippopotamus","silkworm"};
            ...
            if (hypothesis.getHypstr().equals(tab[co])) {
                ...
                if (co == 7) {
                    finish();
                    Intent i = new Intent(Catg1Ls4Activity.this, CardActivity.class);
                    startActivity(i);
        ...
        if(lang==1){
            switchSearch(ANIMAL);
            String tab[] = {"cafard", "hyun", "crocodile", "dinosaure", "rhinocéros","hippopotames","ver" };
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore() * -0.005);
