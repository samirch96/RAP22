...
public class Catg4Ls1Activity extends Activity implements RecognitionListener {
    ...
    public static final String CUISINEFR ="cuisinefr";
    public static final String CUISINIT ="cuisinit";
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg4_ls1);
        ...
        bfr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                reco1.startListening(CUISINEFR);
                switchSearch(CUISINEFR);
      ...
      /*  bes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                reco2.startListening(CUISINIT);
                switchSearch(CUISINIT);
                bfr.setVisibility(View.INVISIBLE);
                ben.setVisibility(View.INVISIBLE);
                bes.setVisibility(View.INVISIBLE);
                lang =3;
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg4Ls1Activity.this);
...
//                        int h = x.getInt("pt_a",0);
                        switch (lang){
                            case 1:
                                    ...
                                    xx.putInt("pt_a", h-20);
                                    xx.apply();*/
                                Intent i1 = new Intent(Catg4Ls1Activity.this, TTSFRActivity.class);
                                startActivity(i1);
                            ...
                            case 2:
                                   ...
                                   /* x = getSharedPreferences("xx", 0);
                                    ...
                                    xx.putInt("pt_a",  h-20);
                                    xx.apply();*/
                                Intent i2 = new Intent(Catg4Ls1Activity.this, TTSActivity.class);
                                startActivity(i2);
        ...
        new Catg4Ls1Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg4Ls1Activity> activityReference;
        SetupTask(Catg4Ls1Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            String tab[]={"blender", "cooker","filter","fridge"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 4){
                    finish();
                    Intent i = new Intent(Catg4Ls1Activity.this, Card4Activity.class);
                    startActivity(i);
        ...
        if(lang==1){
            ...
            switchSearch(CUISINEFR);
            String tab[]={" mixage","cuisinière","filtre","frigidaire"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
        ...
        if(lang==3) {
            switchSearch(CUISINIT);
            //  switchSearch(MUSICAL);
            String tab[] = {"frullatore", "cucina","filo", "frigidità"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore() * -0.005);
    ...
    private void switchSearch(String searchName) {
        ...
        if(lang==1){
            ...
            if (searchName.equals(CUISINEFR))
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File musicgrammer = new File(assetsDir, "cuisine.gram");
        recognizer.addGrammarSearch(CUISIN,musicgrammer);
        ...
        File musicfrgrammer=new File (assetsDir, "cuisinefr.gram");
        reco1.addGrammarSearch(CUISINEFR,musicfrgrammer);
       ...
       /* reco2 = SpeechRecognizerSetup.defaultSetup()
        ...
        // File musicitgrammer=new File (assetsDir, "sync/cuisineit.gram");
        // reco2.addGrammarSearch(CUISINIT,musicitgrammer);
