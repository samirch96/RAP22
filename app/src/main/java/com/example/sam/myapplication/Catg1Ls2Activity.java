...
public class Catg1Ls2Activity extends Activity implements RecognitionListener {
    TextView result;
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg1_ls2);
       ...
       /* bes.setOnClickListener(new View.OnClickListener() {
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg1Ls2Activity.this);
...
//                        int h = x.getInt("pt_a",0);
                        switch (lang){
                            case 1:
                                    ...
                                    xx.putInt("pt_a", h-20);
                                    xx.apply();*/
                                Intent i1 = new Intent(Catg1Ls2Activity.this, TTSFRActivity.class);
                                startActivity(i1);
                            ...
                            case 2:
                                   ...
                                   /* x = getSharedPreferences("xx", 0);
                                    ...
                                    xx.putInt("pt_a",  h-20);
                                    xx.apply();*/
                                Intent i2 = new Intent(Catg1Ls2Activity.this, TTSActivity.class);
                                startActivity(i2);
        ...
        new Catg1Ls2Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg1Ls2Activity> activityReference;
        SetupTask(Catg1Ls2Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2) {
            switchSearch(ANIMALS);
            String tab[] = {"bird", "lion", "tiger", "shark", "snake"};
            ...
            if (hypothesis.getHypstr().equals(tab[co])) {
                ...
                if (co == 5) {
                    finish();
                    Intent i = new Intent(Catg1Ls2Activity.this, CardActivity.class);
                    startActivity(i);
        ...
        if(lang==1){
            switchSearch(ANIMAL);
            String tab[] = {"oiseau", "lion", "tigre", "requin", "serpent" };
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore() * -0.005);
