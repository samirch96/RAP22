...
public class Catg2Ls2Activity extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg2_ls2);
      ...
      /*  bes.setOnClickListener(new View.OnClickListener() {
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg2Ls2Activity.this);
...
//                        int h = x.getInt("pt_a",0);
                        switch (lang){
                            case 1:
                                    ...
                                    xx.putInt("pt_a", h-20);
                                    xx.apply();*/
                                Intent i1 = new Intent(Catg2Ls2Activity.this, TTSFRActivity.class);
                                startActivity(i1);
                            ...
                            case 2:
                                   ...
                                   /* x = getSharedPreferences("xx", 0);
                                    ...
                                    xx.putInt("pt_a",  h-20);
                                    xx.apply();*/
                                Intent i2 = new Intent(Catg2Ls2Activity.this, TTSActivity.class);
                                startActivity(i2);
        ...
        new Catg2Ls2Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg2Ls2Activity> activityReference;
        SetupTask(Catg2Ls2Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            switchSearch(MUSIC);
            //  switchSearch(MUSICAL);
            String tab[]={"tuba", "violin","harp","saxophone","speaker"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 5){
                    finish();
                    Intent i = new Intent(Catg2Ls2Activity.this, Card2Activity.class);
                    startActivity(i);
        ...
        if(lang==1){
            ...
            switchSearch(MUSICAL);
            String tab[]={"tuba", "violon","harp","saxophone","orateur"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
