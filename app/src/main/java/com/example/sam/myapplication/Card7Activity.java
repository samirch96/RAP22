...
public class Card7Activity extends AppCompatActivity {
    Dialog myDialog;
    Button nn,aagd,ff;
    TextView tv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(""+sharedPreferences1.getInt("pt_b", 0));
        nn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card7Activity.this, Catg7LsActivity.class);
                startActivity(i);
            }
        });
        ...
        ff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card7Activity.this, ShaireScoreActivity.class);
                startActivity(i);
            }
        });
    }
