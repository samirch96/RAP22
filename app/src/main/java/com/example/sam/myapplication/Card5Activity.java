...
public class Card5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(""+sharedPreferences1.getInt("pt_e", 0));
        nn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card5Activity.this, Catg5LsActivity.class);
                startActivity(i);
            }
        });
        ...
        ff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card5Activity.this, ShaireScoreActivity.class);
                startActivity(i);
            }
        });
    }
