...
public class Catg5Ls2Activity extends Activity implements RecognitionListener {
    ...
    public static final String ELCTRO="elctro";
    public static final String ELCTROFR ="elctrofr";
    public static final String ELCTROIT ="elctroit";
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg5_ls2);
        ...
        bfr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                reco1.startListening(ELCTROFR);
                switchSearch(ELCTROFR);
        ...
        ben.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                recognizer.startListening(ELCTRO);
                switchSearch(ELCTRO);
                bfr.setVisibility(View.INVISIBLE);
                ben.setVisibility(View.INVISIBLE);
                //    bes.setVisibility(View.INVISIBLE);
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg5Ls2Activity.this);
                a_builder.setMessage("Secrifi 20 points ?").setCancelable(false).setPositiveButton("yes" , new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (lang){
                            case 1:
                                    Intent i1 = new Intent(Catg5Ls2Activity.this, TTSFRActivity.class);
                                    startActivity(i1);
                                break;
                            case 2:
                                    Intent i2 = new Intent(Catg5Ls2Activity.this, TTSActivity.class);
                                    startActivity(i2);
                                break;
                            default:break;
                        }
        ...
        new Catg5Ls2Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg5Ls2Activity> activityReference;
        SetupTask(Catg5Ls2Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            String tab[]={"microphone", "microwave","mixer","modem"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 4){
                    finish();
                    Intent i = new Intent(Catg5Ls2Activity.this, Card5Activity.class);
                    startActivity(i);
        ...
        if(lang==1){
            ...
            switchSearch(ELCTROFR);
            String tab[]={"micro","chauffage","lave-mixage","modem"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
        ...
        if(lang==3) {
            switchSearch(ELCTROIT);
            //  switchSearch(MUSICAL);
            String tab[] = {"frullatore", "pulitore","lavacro", "frigidità"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore() * -0.005);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File musicgrammer = new File(assetsDir, "elctro.gram");
        recognizer.addGrammarSearch(ELCTRO,musicgrammer);
        ...
        File musicfrgrammer=new File (assetsDir, "elctrofr.gram");
        reco1.addGrammarSearch(ELCTROFR,musicfrgrammer);
       ...
       /* reco2 = SpeechRecognizerSetup.defaultSetup()
                ...
                .setAcousticModel(new File(assetsDir,"italylanguage"))
        ...
        // Create keyword-activation search.
        //File musicitgrammer=new File (assetsDir, "elctroit.gram");
        //  reco2.addGrammarSearch(ELCTROIT,musicitgrammer);
