...
public class Card3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(""+sharedPreferences1.getInt("pt_i", 0));
        nn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card3Activity.this, Catg3LsActivity.class);
                startActivity(i);
            }
        });
        ...
        ff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Card3Activity.this, ShaireScoreActivity.class);
                startActivity(i);
            }
        });
    }
