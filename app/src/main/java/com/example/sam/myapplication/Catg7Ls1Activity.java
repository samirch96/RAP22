...
public class Catg7Ls1Activity extends Activity implements RecognitionListener {
    ...
    public static final String BUILDFR ="buildfr";
    public static final String ELCTROIT ="flags";
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg7_ls1);
        ...
        bfr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                reco1.startListening(BUILDFR);
                switchSearch(BUILDFR);
        ...
        ben.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                recognizer.startListening(BUILD);
                switchSearch(BUILD);
                bfr.setVisibility(View.INVISIBLE);
                ben.setVisibility(View.INVISIBLE);
                bl.setVisibility(View.VISIBLE);
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg7Ls1Activity.this);
...
//                        int h = x.getInt("pt_a",0);
                        switch (lang){
                            case 1:
                                    ...
                                    xx.putInt("pt_a", h-20);
                                    xx.apply();*/
                                Intent i1 = new Intent(Catg7Ls1Activity.this, TTSFRActivity.class);
                                startActivity(i1);
                            ...
                            case 2:
                                   ...
                                   /* x = getSharedPreferences("xx", 0);
                                    ...
                                    xx.putInt("pt_a",  h-20);
                                    xx.apply();*/
                                Intent i2 = new Intent(Catg7Ls1Activity.this, TTSActivity.class);
                                startActivity(i2);
        ...
        new Catg7Ls1Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg7Ls1Activity> activityReference;
        SetupTask(Catg7Ls1Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            String tab[]={"saw", "hoe","boot","trowel"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 4){
                    finish();
                    Intent i = new Intent(Catg7Ls1Activity.this, Card7Activity.class);
                    startActivity(i);
        ...
        if(lang==1){
            ...
            switchSearch(BUILDFR);
            String tab[]={"scie","truelle","botte","pelle"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File flagsgrammer = new File(assetsDir, "building.gram");
        recognizer.addGrammarSearch(BUILD,flagsgrammer);
        ...
        File flagsfrgrammer=new File (assetsDir, "buildingfr.gram");
        reco1.addGrammarSearch(BUILDFR,flagsfrgrammer);
