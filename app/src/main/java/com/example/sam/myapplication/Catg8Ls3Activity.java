...
public class Catg8Ls3Activity extends Activity implements RecognitionListener {
    ...
    SharedPreferences sc_m,pt_e,x;

    SharedPreferences.Editor sc_mm,pt_ee,xx;

    Button bfr,ben,bes,bl;

    public static final String FLAGS="flags";
    public static final String FLAGSFR ="flags";
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg8_ls3);
        ...
        bfr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                reco1.startListening(FLAGSFR);
                switchSearch(FLAGSFR);
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg8Ls3Activity.this);
                a_builder.setMessage("Secrifi 20 points ?").setCancelable(false).setPositiveButton("yes" , new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (lang){
                            case 1:
                                    Intent i1 = new Intent(Catg8Ls3Activity.this, TTSFRActivity.class);
                                    startActivity(i1);
                                    break;
                            case 2:

                                    Intent i2 = new Intent(Catg8Ls3Activity.this, TTSActivity.class);
                                    startActivity(i2);
                                    break;
                            default:break;
                        }
        ...
        new Catg8Ls3Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg8Ls3Activity> activityReference;
        SetupTask(Catg8Ls3Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            String tab[]={"turkey", "mauritania","malaysia","canada"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 4){
                    finish();
                    Intent i = new Intent(Catg8Ls3Activity.this, Card8Activity.class);
                    startActivity(i);
                    ...
                    sc_mm.apply();
                    pt_e = getSharedPreferences("pt_e",MODE_PRIVATE);
                    pt_ee = pt_e.edit();
                    pt_ee.putInt("pt_e",po);
                    pt_ee.apply();
                }
        ...
        if(lang==1){
            ...
            switchSearch(FLAGSFR);
            String tab[]={"turquie","mauritanie","malaisie","canada"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore()*-0.005);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File flagsfrgrammer=new File (assetsDir, "flagfr.gram");
        reco1.addGrammarSearch(FLAGSFR,flagsfrgrammer);
