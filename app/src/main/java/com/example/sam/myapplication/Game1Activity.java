...
public class Game1Activity extends Activity implements RecognitionListener {
    ...
    public static final String ANIMALS="animalsss";
    ...
    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Game1Activity> activityReference;
        SetupTask(Game1Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2) {
            ...
            if (hypothesis.getHypstr().equals(tab[co])) {
                ...
                if (co == 6) {
                    finish();
                    Intent i = new Intent(Game1Activity.this, CardActivity.class);
                    startActivity(i);
