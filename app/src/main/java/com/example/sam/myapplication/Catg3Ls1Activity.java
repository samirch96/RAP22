...
public class Catg3Ls1Activity extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.activity_catg3_ls1);
        ...
        bl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Catg3Ls1Activity.this);
                a_builder.setMessage("Secrifi 20 points ?").setCancelable(false).setPositiveButton("yes" , new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (lang){
                            case 1:
                                    Intent i1 = new Intent(Catg3Ls1Activity.this, TTSFRActivity.class);
                                    startActivity(i1);
                                    break;
                            case 2:
                                    Intent i2 = new Intent(Catg3Ls1Activity.this, TTSActivity.class);
                                    startActivity(i2);
                                    break;
                            default:break;
                        }
        ...
        new Catg3Ls1Activity.SetupTask(this).execute();
    }



    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Catg3Ls1Activity> activityReference;
        SetupTask(Catg3Ls1Activity activity) {
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(lang==2){
            ...
            String tab[]={"cd", "monitor","printer","speaker"};
            ...
            if( hypothesis.getHypstr().equals(tab[co])){
                ...
                if (co == 4){
                    finish();
                    Intent i = new Intent(Catg3Ls1Activity.this, Card3Activity.class);
                    startActivity(i);
        ...
        if(lang==1) {
            ...
            switchSearch(INFOFR);
            String tab[] = {"cd", "moniteur", "imprimante", "haut-parleur"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore() * -0.005);
        ...
        if(lang==3) {
            switchSearch(INFOIT);
            //  switchSearch(MUSICAL);
            String tab[] = {"cd", "monitor","stampante", "alto"};
            text = hypothesis.getHypstr();
            int ps_score = (int) (hypothesis.getBestScore() * -0.005);
